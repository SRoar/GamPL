...
prompt = """
Return a valid JSON array of the 11 players for the 2025 Chennai Super Kings squad that most matches the players in the list "arr2".
...
prompt = """
Return a valid JSON array of the 11 players for the 2025 Mumbai Indians squad that most matches the players in the list "arr2".
